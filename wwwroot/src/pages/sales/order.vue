<template>
  <div class="animated fadeIn">
            ...
            <div slot="header">
              ...
              <div right style="float:right;">
                <b-button-toolbar key-nav size="sm">
                  <b-button-group size="sm" class="mx-1" v-if="form.model.DocumentNo != '' && actionButton.AllowApprovalHistory"
                      >
                  </b-button-group> 
                  <b-button-group size="sm" class="mx-1" v-if="actionButton.AllowApproval && form.model.DocumentNo != ''"
                      >
                    ...
                    <b-dropdown size="sm" variant="danger" class="ml-1 " no-caret v-if="form.isEdit" id="button">
                      ...
                      <b-dropdown-item href="#" @click="openModalDisapprove(false)" class="text-danger">
                        <font-awesome-icon :icon="['fas', 'ban']" class="text-danger" />&nbsp;<span class="text-danger">Disapprove/Cancel</span></b-dropdown-item>
                      <b-dropdown-item href="#" @click="openModalDisapprove(true)" class="text-danger">
                        <font-awesome-icon :icon="['fas', 'undo']" class="text-warning" />&nbsp;<span class="text-warning">Ask Revision</span></b-dropdown-item>
                    </b-dropdown>
                  </b-button-group> 
                  <b-button-group size="sm" class="mx-1" v-if="actionButton.AllowSubmitApproval && form.model.DocumentNo != '' && form.isEdit"
                      >
                    <b-button
                      id="button"
                      variant="green"
                      v-b-tooltip.hover
                      title="Submit this Sales Order" @click="clickPosting"
                    >
                      <font-awesome-icon :icon="['fas', 'check-circle']" />&nbsp;Submit
                    </b-button>  
                  </b-button-group> 
                  <b-button-group size="sm" class="mx-1" v-if="!form.isEdit && !form.isView && form.model.TransactionType">
                      <b-button variant="dark" 
                      v-b-tooltip.hover title="Copy From Another Sales Order"
                      @click="onModalSearchSalesOrder('SalesOrderId')">
                        <font-awesome-icon :icon="['fas', 'copy']" />
                      </b-button>
                  </b-button-group>
                  <b-button-group size="sm" class="mx-1" v-if="!form.isView">
                    <b-button variant="blue" type="submit" id="button">
                      <font-awesome-icon :icon="['fas', 'save']" />&nbsp;Save
                    </b-button>
                  </b-button-group>
                  <!-- <b-dropdown variant="link" class="mx-1" no-caret v-if="form.isEdit && actionButton.AllowEdit">
                    <template v-slot:button-content>
                      <font-awesome-icon :icon="['fas', 'cog']" variant="dark" class="text-secondary" />
                    </template>
                    <b-dropdown-item href="#" @click="handleReverse" class="text-danger">
                      <font-awesome-icon :icon="['fas', 'trash']" class="text-danger" />&nbsp;<span class="text-danger">Revise Sales Order</span></b-dropdown-item>
                  </b-dropdown> -->
            ...
            <b-row>
              <b-col sm="10">
                <b-row>
                  ...
                  <b-col sm="6" lg="3">
                        <label>Quotation Doc. No</label>
                        <validation-provider
                          name="Quotation Doc No"
                          :rules="{ required: false }"
                          v-slot="validationContext"
                        >
                          <b-input-group prepend>
                            <b-form-input
                              v-model="form.model.QuotDocumentNo"
                              class="font-weight-bold"
                              readonly
                              :state="validateState(validationContext)"
                              size="sm"
                              aria-describedby="Quotation-DocNo"
                            ></b-form-input>
                            <b-input-group-append>
                              <b-button
                                ...
                                size="sm"
                                v-show="!form.isView"
                                :disabled="form.isEdit || form.isView || form.model.TransactionType == ''"
                                @click="onModalSearchQuotation('QuotDocumentNo')"
                              >
              ...
              <b-col sm="2" v-if="form.isEdit || form.isView">   
                <b-input-group >       
                        ...
                        <b-col sm="3">
                              ...
                              >
                                <b-input-group prepend>
                                  ...
                                  ></b-form-input>
                                  <b-input-group-append v-show="!form.isView">
                                    <b-button
                                      variant="outline-primary"
                                      size="sm"
                            ...
                            <b-form-group>
                              ...
                              >
                                <b-input-group prepend>
                                  <b-form-input
                                    name="MasterNo"
                                    type="text" class="font-weight-bold form-control"
                            ...
                            <b-input-group prepend>
                              ...
                              <b-input-group-append>
                                ...
                                <b-button
                                  ...
                                  variant="outline-primary"
                                  size="sm"
                                  @click="onModalCustomerAddressDetail(form.model.NotifyPartnerId,form.model.NotifyPartnerAddressCode,form.model.NotifyPartnerBillAddressCode,form.model.NotifyPartnerShipAddressCode,form.model.NotifyPartnerCode)"
                                >
                                  <font-awesome-icon :icon="['fas', 'edit']"></font-awesome-icon>
                                </b-button>
                              </b-input-group-append>
                          ...
                          <tbody class="position-relative buying">
                            <template v-for="(item, itemIndex) in chargesDetails">
                                ...
                                <td style="width:10%">
                                  <b-input-group prepend>
                                    <b-form-input
                                      ...
                                      size="sm"
                                    ></b-form-input>
                                    <b-input-group-append v-if="!form.isView">
                                      <b-button
                                        variant="outline-primary"
                                        size="sm"
                                      ...
                                      <b-input-group-append v-show="!form.isView && form.FunctionalCurrency != item.CurrencyCode">
                                        <b-button 
                                          variant="outline-primary"
                                          size="sm"
                              ...
                              <tr>
                                ...
                                <td colspan="8">
                                  <b-form-input type="text" size="sm" v-model="item.Remark" :disabled="form.isView" />
                                </td>
                              </tr>
                              <template v-for="(itemBuying, BuyingIndex) in item.SoBuyings">
                                <tr class="row-buying">
                                  ...
                                  <td>
                                    <b-input-group prepend>
                                      ...
                                      <b-input-group-append>
                                        ...
                                        <b-input-group-append v-show="!form.isView && form.FunctionalCurrency != itemBuying.CurrencyCode">
                                          <b-button
                                            variant="outline-primary"
                                            size="sm"
    ...
    <b-tabs pills card v-show="!isForm">
      <b-tab active @click="isTabMain=true">
        ...
        <b-row>
          <b-col cols="12" sm="12">
            <b-card >
              <DataGrid id="grid-progress"
                ref="gridMain"
                :fields="this.$store.state.features.sales.sales_order.headers"
                :items="this.$store.state.features.sales.sales_order.data"
                :info="this.$store.state.features.sales.sales_order.listInfo"
                :baseUrl="this.$store.state.features.sales.sales_order.baseUrl"
      ...
      <b-tab @click="isTabMain=false">
        ...
        <b-card-text>
          <b-row>
            <b-col cols="12" sm="12">
              <b-card width="100%">
                <DataGrid id="grid-history"
                  ref="gridHistory"
                  :fields="this.$store.state.features.sales.sales_order_history.headers"
                  :items="this.$store.state.features.sales.sales_order_history.data"
                  :info="this.$store.state.features.sales.sales_order_history.listInfo"
                  :baseUrl="this.$store.state.features.sales.sales_order_history.baseUrl"
    ...
    <!-- == COPY SALES ORDER START == -->
      <div id="page-dialogs">
        <b-modal v-model="isShowSalesOrderCopy" hide-footer size="xl">
          <template v-slot:modal-title>Sales Order</template>
          <vue-element-loading :active="blockLoaderModal" spinner="bar-fade-scale" color="#F06292" size="50" />
          <b-row>
          <b-col lg="2">
            <b-form-checkbox size="sm"
              v-model="withDetailContainer"
              name="withdetail">with <code class="font-weight-bold">DETAIL CONTAINER</code></b-form-checkbox>
          </b-col>
          <b-col lg="2">
            <b-form-checkbox lg="3" size="sm"
              v-model="withDetailTrucking"
              name="withdetail">with <code class="font-weight-bold">DETAIL TRUCKING</code></b-form-checkbox>
          </b-col>
          <b-col lg="2">
            <b-form-checkbox sm="3" size="sm"
              v-model="withDetailCharges"
              @click.native="handleDetailCharges()"
              name="withdetail">with <code class="font-weight-bold">DETAIL CHARGES</code></b-form-checkbox>
              &nbsp;
          </b-col>
          </b-row>
          <div class="d-block">
            <small>Select <b-icon id="icon" icon="circle" variant="primary"></b-icon> 
             to copy Sales Order!</small>
            <SelectGrid
              ref="gridSalesOrder"
              :fields="this.$store.state.features.sales.sales_order_all.headers"
              :items="this.$store.state.features.sales.sales_order_all.data"
              :info="this.$store.state.features.sales.sales_order_all.listInfo"
              :baseUrl="this.$store.state.features.sales.sales_order_all.baseUrl"
              :actGetData="handleGetSalesOrder"
              :selectedItem="form.model.SalesOrderId"
              selectedFieldName="SalesOrderId"
              :actSelectRow="handleSelectSalesOrder"
              addTableClasses="table-bordered"
              responsive
              loading
              hover
    ...
    <QuotationModal ref="dlgSalesqutotation" :actSelectedRow="onSelectedQuotation"></QuotationModal>
    ...
    <b-modal id="modal-action-approve"
             ref="modalApprove"
      ...
      <form ref="formApprove" @submit.stop.prevent="handleActionApprove">
        <b-form-group :state="approvalState"
                      label="Reason"
    ...
    <b-modal id="modal-action-disapprove"
      ...
      <template v-slot:modal-footer>
        <div class="w-100"> 
          <b-button variant="danger" v-if="!form.approval.AskRevision"
                    size="sm"
                    class="float-right"
          ...
          <b-button variant="warning" v-if="form.approval.AskRevision"
                    size="sm"
                    class="float-right"
    ...
    <b-toast id="document-status-toaster" variant="warning" solid >
      ...
      <table v-if="form.CurrentApprovers.length" width="100%">
        <thead>
          <tr >
            <th class="text-uppercase" style="border-bottom:solid 1px;"><small>Current Process Approvers :</small></th>            
          </tr>
        </thead>  
        <template v-for="(approver, itemIndex) in form.CurrentApprovers">
          <tr >
            <td><code class="font-weight-bold text-uppercase">{{approver.PersonFullName}}</code></td>
          </tr>
        </template>  
...
export default {
  ...
  data() {
    return {
      ...
      formCaption: "Sales Order",
      caption: "Sales Order",
      blockLoader: false,
      blockLoaderModal: false,
      ...
      isShowContainer: false,
        isShowSalesOrderCopy: false,
        withDetailContainer: false,
        withDetailTrucking: false,
        withDetailCharges: false,
  ...
  async mounted() {
    await this.$store.dispatch(
      "features/sales/sales_order/actGetData",
      "GetSalesOrderProgress?"
    );
    await this.$store.dispatch(
      "features/sales/sales_order_history/actGetData",
  ...
  methods: {
    calculateTax(record) {
      ...
      record.OriginatingAmount = record.UnitAmount * record.Quantity;
    ...
    async doCalculateChargeDetails() {
      ...
      if (Array.isArray(this.chargesDetails) && this.chargesDetails.length) {
        for (let i = 0; i < this.chargesDetails.length; i++) {
          ...
          //CALCULATE BUYINGS
          for (let j = 0; j < record.SoBuyings.length; j++) {
            let buying = this.calculateTax(record.SoBuyings[j]);
    ...
    showLoaderModal(val) {
      if (!val) {
        setTimeout(() => {
          this.blockLoaderModal = false;
        }, 300);
      } else {
        this.blockLoaderModal = val;
      }
    },
    ...
    async initDefaultForm() {
      ...
      const trxModule = this.$store.state.features.sales.sales_order.TrxModule;
      const docFeatureId = this.$store.state.features.sales.sales_order
        .DocFeatureId;
    ...
    async handleGetProgress(url) {
      await this.$store.dispatch("features/sales/sales_order/actGetData", url);
      await this.updateToken();
    },
    async handleGetHistory(url) {
      await this.$store.dispatch("features/sales/sales_order_history/actGetData", url);
      await this.updateToken();
    },
    async onFormClose() {
      this.ErrorMessage = "";
    ...
    resetForm() {
      ...
      this.form.model.IsFeederLineMaster = true;
    ...
    async handleView(row){
      ...
      this.form.model.ShippingLineVesselName= row.ShippingLineVesselName;      
      this.form.model.ShippingLineDelivery= row.ShippingLineDelivery != undefined ? moment(row.ShippingLineDelivery).format('YYYY-MM-DD') : null;
      this.form.model.ShippingLineArrival= row.ShippingLineArrival != undefined ? moment(row.ShippingLineArrival).format('YYYY-MM-DD') : null;
      ...
      var arrdata = cloneDeep(row.SalesOrderSellings);
      ...
      arrdata.forEach(function(item, index) {
        ...
        for (var i = 0; i < item.SoBuyings.length; i++) {
          discPercentage = 0;

          if (item.SoBuyings[i].OriginatingDiscount > 0) {
            discPercentage =
              (
                item.SoBuyings[i].OriginatingDiscount /
                item.SoBuyings[i].OriginatingAmount
              ).toFixed(2) * 100;
          }

          item.SoBuyings[i].Index = i;
          item.SoBuyings[i].DiscountPercentage = discPercentage;
          item.SoBuyings[i].DiscountByAmount = false;
          item.SoBuyings[i].TaxPercentDiscount =
            item.SoBuyings[i].PercentDiscount;
          //item.SoBuyings[i].IsDeleted = false;

          item.SoBuyings[i].moneyOptionsarr = {
            decimal: ",",
            thousands: ".",
            prefix: "",
            suffix: "",
            precision: item.SoBuyings[i].DecimalPlaces,
            masked: false,
            allowBlank: false,
            min: 0
          };
      ...
      //BEGIN TRUCKS
      this.truckDetails = cloneDeep(row.SalesOrderTruckings);
      //END TRUCKS

      //BEGIN CONTAINERS
      this.containerDetails = cloneDeep(row.SalesOrderContainers);
      //END CONTAINERS
    ...
    async DeleteBuying(index, buyingIndex) {
      this.$bvModal
        ...
        .then(ok => {
          if (ok) {
            this.chargesDetails[index]["SoBuyings"].splice(buyingIndex, 1);

            /*this.chargesDetails[index]["SoBuyings"][
              buyingIndex
            ].IsDeleted = true;*/
          }
        })
    ...
    async doDelete(row) {
      ...
      await this.$store.dispatch("features/sales/sales_order/actDelete", row);

      var response = this.$store.state.features.sales.sales_order.resultDelete;
    ...
    async handleReverse() {
      this.$bvModal
        .msgBoxConfirm("This Sales Order will be deleted and " + this.form.model.DocumentNo + " can be editable.\nDo you want to continue ?", {
    ...
    async prepareFormData() {
      this.chargesDetails.forEach(function(item, index){
        ...
        if(item.SoBuyings.length){
          item.SoBuyings.forEach(function(buy, bindex){
            buy.RowIndex = bindex;
          })
        }
      });

      this.form.model.SalesOrderSellings = this.chargesDetails;

      this.containerDetails.forEach(function(item, index){
        item.RowIndex = index;
      });
      this.form.model.SalesOrderContainers = this.containerDetails;

      this.truckDetails.forEach(function(item, index){
        item.RowIndex = index;
      });
      this.form.model.SalesOrderTruckings = this.truckDetails;
    },
    async onSubmit() {
      if (this.validateForm()) {
        ...
        if (this.form.isEdit) {
          await this.$store.dispatch(
            "features/sales/sales_order/actUpdate",
            this.form.model
          );
          var response = this.$store.state.features.sales.sales_order
            .resultUpdate;
          if (response.status != 200) {
            this.handleToast(
              "Confirmation",
          ...
          await this.$store.dispatch(
            "features/sales/sales_order/actCreate",
            this.form.model
          );
    ...
    async onSelectedExtendedTax(item, modelReff) {
      if (item.ReffObj != undefined) {
          ...
          if (chargeType["TYPE"] == "SELL" && item.ReffObj.length < 3) {
            ...
            let buying = this.chargesDetails.filter(x =>x.Index == reffSell.Index && x.ChargesId == reffSell.ChargesId)[0].SoBuyings. filter(y =>y.Index == reffBuy.Index && y.ChargesId == reffBuy.ChargesId)[0];
    ...
    async onModalSearchQuotation(row) {
      this.$refs.dlgSalesqutotation
        .open(
          row,
          this.form.model[row],
          this.form.model.TransactionType,
    ...
    async onSelectedQuotation(row, modelReff) {
      this.form.model.SalesQuotationId = row.SalesQuotationId;
      //this.form.model.TransactionType = row.TransactionType;
      this.form.model.QuotDocumentNo = row.DocumentNo;
      ...
      await this.$store.dispatch(
        "features/company/customer/actGetData",
        "Customer?" + "&CustomerCode=" + row.CustomerCode + "&Inactive=false"
      );
      var cust = this.$store.state.features.company.customer.data;
      if (cust.length > 0) {
        this.form.model.CustomerBillToAddressCode = cust[0].BillToAddressCode;
        this.form.model.CustomerShipToAddressCode = cust[0].ShipToAddressCode;
      }
      ...
      await this.$store.dispatch(
        "features/company/customer/actGetData",
        "Customer?" + "&CustomerCode=" + row.ShipperCode + "&Inactive=false"
      );
      var ship = this.$store.state.features.company.customer.data;
      if (ship.length > 0) {
        this.form.model.ShipperBillToAddressCode = ship[0].BillToAddressCode;
        this.form.model.ShipperShipToAddressCode = ship[0].ShipToAddressCode;
      }
      this.form.model.ShipperName = row.ShipperName;
      this.form.model.ConsigneeId = row.ConsigneeId;
      this.form.model.ConsigneeCode = row.ConsigneeCode;
      ...
      await this.$store.dispatch(
        "features/company/customer/actGetData",
        "Customer?" + "&CustomerCode=" + row.ConsigneeCode + "&Inactive=false"
      );
      var consigne = this.$store.state.features.company.customer.data;
      if (consigne.length > 0) {
        this.form.model.ConsigneeBillToAddressCode =
          consigne[0].BillToAddressCode;
        this.form.model.ConsigneeShipToAddressCode =
          consigne[0].ShipToAddressCode;
      }
      this.form.model.ConsigneeAddressCode = row.ConsigneeAddressCode;
      this.form.model.IsDifferentNotifyPartner = row.IsDifferentNotifyPartner;
      this.form.model.NotifyPartnerId = row.NotifyPartnerId;
      ...
      await this.$store.dispatch(
        "features/company/customer/actGetData",
        "Customer?" + "&CustomerId=" + row.NotifyPartnerId + "&Inactive=false"
      );
      var notify = this.$store.state.features.company.customer.data;
      if (notify.length > 0) {
        this.form.model.NotifyPartnerBillAddressCode =
          notify[0].BillToAddressCode;
        this.form.model.NotifyPartnerShipAddressCode =
          notify[0].ShipToAddressCode;
      }
    ...
    async handleGetSalesOrder(url){
        await this.$store.dispatch(
          "features/sales/sales_order_all/actGetData",
          url
        );
    },
    async handleDetailCharges(){
      if(!this.withDetailCharges){
        this.showLoaderModal(true);
            await this.$store.dispatch(
            "features/sales/sales_order_all/actGetData",
            "GetSalesOrderAll?&TransactionType=" + this.form.model.TransactionType
          );
    ...
    async onModalSearchSalesOrder(reff){
      this.withDetailContainer = false;
      this.withDetailTrucking = false;
      this.withDetailCharges = false;
      await this.handleGetSalesOrder();

      this.isShowSalesOrderCopy = true;
    },

    async handleSelectSalesOrder(row){
      this.$bvModal
        .msgBoxConfirm(
          "All Data in this form will be OVERWRITE with new selected Sales Order!", {
          title: "Are you sure?",
          size: "sm",
          buttonSize: "sm",
          okVariant: "blue",
    ...
    async doSelectSalesOrder(row){
        //NS BEGIN
          ...
          this.isShowSalesOrderCopy = false;
    },
    ...
    // START POSTING / SUBMIT
      ...
      async doPosting(row) {
        ...
        await this.$store.dispatch(
          "features/sales/sales_order/actPosting",
          this.form.model
        );
        var response = this.$store.state.features.sales.sales_order.resultUpdate;
        if (response.status != 200) {
          this.handleToast(
            "Confirmation",
            "danger",
    ...
    async doActionApprove() {
        ...
        this.form.model.SalesOrderId = this.form.model.SalesOrderId;
        this.form.model.ApprovalIndex = this.form.approval.ApprovalIndex;

        await this.$store.dispatch("features/sales/sales_order/actApprovalApprove", this.form.model);
      ...
      async doActionDisapprove() {
        ...
        await this.$store.dispatch("features/sales/sales_order/actApprovalDisapprove", this.form.model);
      ...
      async doActionRevise() {
        ...
        await this.$store.dispatch("features/sales/sales_order/actApprovalRevise", this.form.model);
