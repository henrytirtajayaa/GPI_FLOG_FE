      ...
      <div ref="document" v-if="isDataReady">
        <table width="100%" style="font-size:12px;font: 8pt normal Helvetica, Arial, sans-serif;">
          ...
          <tr>
            <td style="text-align:center;font-size:14px;" colspan="2">
              <strong>{{data.PayableTransaction.DocumentType}}</strong>
            </td>
          </tr>
        </table>
        ...
        <div id="body">
                ...
                <td style="width:60%;">
                  <table style="width:100%;">
                    <tr style="vertical-align: top;">
                      ...
                      <td>:</td>
                      <td>{{data.PayableTransaction.VendorName}}</td>
                      <td style="width:150px;">
                        <strong>Document No</strong>
                      </td>
                      <td>:</td>
                      <td>{{data.PayableTransaction.DocumentNo}}</td>
                    </tr>
                    <tr>
                      <td style="width:150px;">
                        <strong></strong>
                      ...
                      <td></td>
                      <td>{{data.PayableTransaction.BillToAddressCode}}</td>
                      <td>
                        <strong>Document Date</strong>
                      </td>
                      <td>:</td>
                      <td>{{data.PayableTransaction.TransactionDate | filterDate}}</td>
                    </tr>
                    <tr>
                      <td style="width:150px;">
                        <strong></strong>
                      ...
                      <td></td>
                      <td>{{data.PayableTransaction.VendorAddress}}</td>
                      <td>
                        <strong>PO Document No</strong>
                      </td>
                      <td>:</td>
                      <td>{{data.PayableTransaction.SoDocumentNo}}</td>
                    </tr>
                    <tr>
                      <td>
                      ...
                      <td>:</td>
                      <td>{{data.PayableTransaction.CurrencyCode}}</td>
                      <td>
                        <strong>NS Document No</strong>
                      </td>
                      <td>:</td>
                      <td>{{data.PayableTransaction.NSDocumentNo}}</td>
                    </tr>
                  </table>
                </td>
              </tr>
          ...
          >
            ...
            <tr v-for="(item, itemIndex) in data.PayableTransactionDetails">
              <td
            ...
            <tr v-for="(item) in numbers" v-if="data.PayableTransactionDetails.length<5">
            ...
            <tr>
              ...
              <td style="padding:5px 3px;border-top:1px solid black;" class="text-right">
                {{data.PayableTransaction.OriginatingExtendedAmount | currency({symbol: '', fractionCount: '2', fractionSeparator: ',',
                thousandsSeparator: '.', symbolPosition: '', symbolSpacing: ''})}}
              </td>
            </tr>
            <tr v-if="data.PayableTransaction.DiscountAmount > 0">
              <td
                style="padding:5px 3px;border-top:1px solid black;border-right:1px solid black;"
                class="text-right"
                colspan="2"
              ...
              <td style="padding:5px 3px;border-top:1px solid black;" class="text-right">
                {{data.PayableTransaction.DiscountAmount | currency({symbol: '', fractionCount: '2', fractionSeparator: ',',
                thousandsSeparator: '.', symbolPosition: '', symbolSpacing: ''})}}
              </td>
            </tr>
            <tr>
              ...
              <td style="padding:5px 3px;border-top:1px solid black;" class="text-right">
                {{data.PayableTransaction.TaxAmount | currency({symbol: '', fractionCount: '2', fractionSeparator: ',',
                thousandsSeparator: '.', symbolPosition: '', symbolSpacing: ''})}}
              </td>
            </tr>
            <tr>
              ...
              <td style="padding:5px 3px;border-top:1px solid black;" class="text-right">
                {{data.PayableTransaction.SubtotalAmount | currency({symbol: '', fractionCount: '2', fractionSeparator: ',',
                thousandsSeparator: '.', symbolPosition: '', symbolSpacing: ''})}}
              </td>
            </tr>
          </table>
          <table style="font: 8pt normal Helvetica, Arial, sans-serif;margin-top:20px;">
            <tr>
              ...
              >{{data.PayableTransaction.SubtotalAmount, data.Currency.CurrencyUnit, data.Currency.CurrencySubUnit | toWords}}</th>
            </tr>
            <tr>
              <th style="padding:0px 3px;">DESCRIPTION</th>
              <th>:</th>
              <td style="padding:0px 3px;">{{data.PayableTransaction.Description}}</td>
            </tr>
          </table>
          <table style="font: 8pt normal Helvetica, Arial, sans-serif;margin-top:20px;">
            <tr>
          ...
          <!-- <table  style="width:50%;border:1px solid black;margin-top:20px;font: 8pt normal Helvetica, Arial, sans-serif;">
            <tr>
                <th style="padding:5px 3px;border-bottom:1px solid black;border-right:1px solid black;">CREATED BY</th>
                <th style="padding:5px 3px;border-bottom:1px solid black;border-right:1px solid black;">CHECKED BY</th>
                <th style="padding:5px 3px;border-bottom:1px solid black;">APPROVED BY</th>
            </tr>
            <tr>
                <td style="padding:5px 3px;border-bottom:1px solid black;border-right:1px solid black;">&nbsp;<br/><br/><br/></td>
                <td style="padding:5px 3px;border-bottom:1px solid black;border-right:1px solid black;">&nbsp;</td>
                <td style="padding:5px 3px;border-bottom:1px solid black;">&nbsp;</td>
            </tr>
            <tr>
                <td style="padding:5px 3px;border-bottom:1px solid black;border-right:1px solid black;"><strong>{{Approval.CreatedByName}}</strong></td>
                <td style="padding:5px 3px;border-bottom:1px solid black;border-right:1px solid black;">&nbsp;</td>
                <td style="padding:5px 3px;border-bottom:1px solid black;">&nbsp;</td>
            </tr>
          </table>-->
          ...
          >
            <!-- <tr>
                <th style="width:50%;padding:5px 3px;border-bottom:1px solid black;border-right:1px solid black;">PAID BY</th>
          ...
          <table style="font: 8pt normal Helvetica, Arial, sans-serif;margin-top:20px;width:100%;">
            <tr>
