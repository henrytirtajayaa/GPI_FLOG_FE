        ...
        <div id="content">
          <div id="body">
                  ...
                  <td style="width:60%;">
                    <table style="width:100%;">
                      <tr style="vertical-align: top;">
                        ...
                        <td>:</td>
                        <td>{{data.VendorPayment.DocumentNo}}</td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>:</td>
                        <td>{{data.VendorPayment.TransactionDate | filterDate}}</td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>:</td>
                        <td>{{data.VendorPayment.VendorName}}</td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>:</td>
                        <td>{{data.VendorPayment.CurrencyCode}}</td>
                      </tr>
                      <tr>
                        <td>
                        ...
                        <td>:</td>
                        <td>{{data.VendorPayment.Description}}</td>
                      </tr>
                    </table>
                  </td>
                </tr>
            ...
            >
              ...
              <tr v-for="(item, itemIndex) in data.ApPaymentDetails">
                <td
              ...
              <tr v-for="(item) in numbers" v-if="data.ApPaymentDetails.length<5">
              ...
              <tr>
                ...
                <td style="padding:5px 3px;border-top:1px solid black;" class="text-right">
                  {{data.VendorPayment.AppliedTotalPaid | currency({symbol: '', fractionCount: '2', fractionSeparator: ',',
                  thousandsSeparator: '.', symbolPosition: '', symbolSpacing: ''})}}
                </td>
              </tr>
            </table>
            <table style="font: 8pt normal Helvetica, Arial, sans-serif;margin-top:20px;">
              <tr>
                ...
                >{{data.VendorPayment.AppliedTotalPaid, data.Currency.CurrencyUnit, data.Currency.CurrencySubUnit | toWords}}</th>
              </tr>
            </table>
            <table
            ...
            >
              ...
              <tr>
                <td
                  style="padding:5px 3px;border-bottom:1px solid black;border-right:1px solid black;"
                >
                  <strong>{{data.VendorPayment.CreatedByName}}</strong>
                </td>
                <td
                  style="padding:5px 3px;border-bottom:1px solid black;border-right:1px solid black;"
                >&nbsp;</td>
            ...
            <table
              style="font: 8pt normal Helvetica, Arial, sans-serif;margin-top:20px;width:100%;"
            >
              <tr>
