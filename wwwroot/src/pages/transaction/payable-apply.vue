...
<template>
  <div class="animated fadeIn">
              ...
              <b-card>
                      ...
                      <b-col sm="3">
                        <validation-provider name="Transaction Type"
                          ...
                          <b-form-group>
                            ...
                            <b-form-select name="Document Type" id="DocType"
                              ...
                              <b-form-group>
                                ...
                                <validation-provider name="Vendor Code"
                                  ...
                                  <b-input-group prepend>
                                    <b-form-input v-model="form.display.VendorCode"
                                                  readonly
                                                  size="sm"
                                                  :state="validateState(validationContext)"
                                    ...
                                    <b-input-group-append v-if="actionButton.AllowEdit && form.model.DocumentNo == ''">
                                      <b-button variant="outline-primary"
                                                size="sm"
                                                @click="onModalSearchVendor('VendorId')">
                          ...
                          <b-row>
                            <b-col sm="10">
                              <b-form-group>
                                ...
                                <b-form-input v-model="form.display.VendorName"
                          ...
                          <b-row>
                            <b-col sm="6">
                              <b-form-group v-if="form.model.DocumentType=='ADVANCE'">
                                ...
                                <validation-provider name="Advance Payment No"
                                                     :rules="{ required: true }"
                                                     v-slot="validationContext">
                                  <b-input-group prepend>
                                    <b-form-input v-model="form.display.ReffDocumentNo"
                                                  readonly
                                                  size="sm"
                                                  :state="validateState(validationContext)"
                                                  aria-describedby="reff-doc-no-feedback"></b-form-input>
                                    <b-input-group-append v-if="actionButton.AllowEdit && form.model.DocumentNo == ''">
                                      <b-button variant="outline-primary"
                                                size="sm"
                                                @click="onOpenSelectApplyOption"
                                                :disabled="form.display.VendorCode == ''">
                                        <font-awesome-icon :icon="['fas', 'search']"></font-awesome-icon>
                                      </b-button>
                                    </b-input-group-append>
                                    <b-form-invalid-feedback id="reff-doc-no-feedback">{{ validationContext.errors[0] }}</b-form-invalid-feedback>
                                  </b-input-group>
                                </validation-provider>
                              </b-form-group>
                              <b-form-group v-if="form.model.DocumentType=='PAYMENT'">
                                <label for="ReffDocumentNo">Payment Doc. No</label>
                                <validation-provider name="Payment Payment No"
                                                     :rules="{ required: true }"
                                                     v-slot="validationContext">
                                  <b-input-group prepend>
                                    <b-form-input v-model="form.display.ReffDocumentNo"
                              ...
                              <b-form-group v-if="form.model.DocumentType=='CREDIT NOTE'">
                                ...
                                <validation-provider name="Credit Note No"
                                                     :rules="{ required: true }"
                                                     v-slot="validationContext">
                                  <b-input-group prepend>
                                    <b-form-input v-model="form.display.ReffDocumentNo"
                                                  ...
                                                  size="sm"
                                                  :state="validateState(validationContext)"
                                                  aria-describedby="credit-doc-no-feedback"></b-form-input>
                                    <b-input-group-append v-if="actionButton.AllowEdit && form.model.DocumentNo == ''">
                                      <b-button variant="outline-primary"
                                                size="sm"
                                                @click="onOpenSelectApplyOption"
                                    ...
                                    <b-form-invalid-feedback id="credit-doc-no-feedback">{{ validationContext.errors[0] }}</b-form-invalid-feedback>
                                  </b-input-group>
                                </validation-provider>
                              </b-form-group>
                            </b-col>
                            <b-col sm="5">
                              ...
                              <b-form-input v-model="form.display.CurrencyCode"
                                            class="text-center font-weight-bold"
                                            readonly
                                            size="sm"></b-form-input>
                            </b-col>
                            <b-col sm="7" v-show="actionButton.AllowSave">
                              ...
                              <money v-model="form.display.AvailableBalance"
                                     v-bind="moneyOptions"
                                     size="sm"
                                     disabled
                                     class="currency-money-field"
                                     style="width:93%;"></money>
                            </b-col>
                          </b-row>
                        </b-card>
                      </b-col>
                ...
                <b-row class="mt-3 mb-2">
                  <b-col>
                    <b-button
                      variant="yellow"
                      :disabled="form.model.VendorId == '' || form.display.ReffDocumentNo == ''"
                      size="sm"
                      type="button"
                      @click="onAddPayableInvoice"
                    ...
                    >
                      <thead>
                        <tr>
                          ...
                          <th class="text-left">VENDOR DOC NO</th>
                          ...
                          <tr>
                            ...
                            <td width="10%">
                              <b-form-input
                                type="text"
                                size="sm"
                                v-model="item.PayableTransactionId"
                                v-show="false"
                              />
                              {{item.DocumentNo}}
                            </td>
        ...
        <b-row>
          <b-col cols="12" sm="12">
            <b-card width="100%">
              <DataGrid
                ref="gridProgress"
                :fields="this.$store.state.features.finance.payable_apply.progress.headers"
                :items="this.$store.state.features.finance.payable_apply.progress.data"
                :info="this.$store.state.features.finance.payable_apply.progress.listInfo"
                :baseUrl="this.$store.state.features.finance.payable_apply.progress.baseUrl"
                ...
                pagination
                column-filter
                caption="Payable Apply - Progress"
              ></DataGrid>
            </b-card>
          </b-col>
        </b-row>
          ...
          <b-row>
            <b-col cols="12" sm="12">
              <b-card width="100%">
                <DataGrid
                  ref="gridHistory"
                  :fields="this.$store.state.features.finance.payable_apply.history.headers"
                  :items="this.$store.state.features.finance.payable_apply.history.data"
                  :info="this.$store.state.features.finance.payable_apply.history.listInfo"
                  :baseUrl="this.$store.state.features.finance.payable_apply.history.baseUrl"
      ...
      <b-modal v-model="isShowSelectADV" hide-footer size="lg">
        ...
        <div class="d-block text-center">
          <SelectGrid
            ...
            :items="this.$store.state.features.finance.payable_apply.progress.dataADV"
            :info="this.$store.state.features.finance.payable_apply.progress.listInfoADV"
            :baseUrl="this.$store.state.features.finance.payable_apply.progress.baseUrlADV"
      ...
      <b-modal v-model="isShowSelectCN" hide-footer size="lg">
        ...
        <div class="d-block text-center">
          <SelectGrid ref="gridSelectCN"
                      ...
                      :items="this.$store.state.features.finance.payable_apply.progress.dataCN"
                      :info="this.$store.state.features.finance.payable_apply.progress.listInfoCN"
                      :baseUrl="this.$store.state.features.finance.payable_apply.progress.baseUrlCN"
    ...
    <!-- BEGIN MODAL UNAPPLY PAYMENT -->
    <div id="page-dialog-unapply">
      <b-modal v-model="isShowSelectUnapply" hide-footer size="lg">
        <template v-slot:modal-title>Unapply Vendor Payment</template>
        <div class="d-block text-center">
          <SelectGrid
            ...
            :fields="[{label: 'Document No', key: 'DocumentNo', _classes: 'text-left', width:150, filter: true},
                      ...
                      {label: 'Currency', key: 'CurrencyCode', _classes: 'text-center', width:90, filter: true},
                      {label: 'Balance', key: 'OriginatingBalance', _classes: 'text-right',  filter: true, currency:true},]"
            :items="this.$store.state.features.finance.payable_apply.progress.dataUnapply"
            :info="this.$store.state.features.finance.payable_apply.progress.listInfoUnapply"
            :baseUrl="this.$store.state.features.finance.payable_apply.progress.baseUrlUnapply"
    ...
    <b-modal v-model="isShowSelectInvoice" hide-footer size="lg">
      ...
      <div class="d-block text-center">
        <SelectGrid ref="gridSelectPayable"
                    :fields="[{label: 'Doc. No', key: 'DocumentNo', width:130},
                      {label: 'Trx. Date', key: 'TransactionDate', filter_date:true, filter:false, width:80, _classes:'text-center'},
                      ...
                      {label: 'Org. Balance', key: 'OriginatingBalance',_classes: 'text-right currency',currency: true,filter: false}
                    ]"
                    ...
                    :actGetData="handleGetSelectPayable"
...
<script>
  ...
  import { DistributionJournalModal, VendorModal } from "@/pages/modal/index.js";
  ...
  export default {
    ...
    data() {
      return {
        ...
        isTabMain: true,
        formCaption: "Payable Apply",
        caption: "Payable Apply",
        blockLoader: false,
        isForm: false,
        moneyOptions: {
          decimal: ",",
        ...
        form: {
          ...
          isEdit: false,
          model: {
            PayableApplyId: "00000000-0000-0000-0000-000000000000",
            TransactionDate: moment().format("YYYY-MM-DD"),
            CheckbookTransactionId: "00000000-0000-0000-0000-000000000000", //ADVANCE PAYMENT
            PayableTransactionId: "00000000-0000-0000-0000-000000000000", //CREDIT NOTE
            PaymentHeaderId: "00000000-0000-0000-0000-000000000000", //UNAPPLY
            DocumentType: "",
    ...
    watch: {
      "form.model.DocumentType"(newVal) {
        if(this.form.model.DocumentNo == '' && !this.form.isEdit){
          ...
          this.form.model.PayableTransactionId = "00000000-0000-0000-0000-000000000000";
          this.form.model.PaymentHeaderId = "00000000-0000-0000-0000-000000000000";
    ...
    async mounted() {
      ...
      await this.$store.dispatch(
        "features/finance/payable_apply/progress/actGetData",
        "GetProgressApplyPayable?"
      );
      await this.$store.dispatch(
        "features/finance/payable_apply/history/actGetData",
        "GetHistoryApplyPayable?"
      );
    ...
    methods: {
      ...
      async limitValue(index) {
        if (
          ...
          this.handleToast(
            "Confirmation",
            "warning",
            "Paid Amount can't be more than invoice remaining amount"
          );
        }
      },
      ...
      async handleGetSelectADV(url) {
        if (url == undefined) {
          url = this.$store.state.features.finance.payable_apply.progress
            .baseUrlADV;
          url = url + "VendorId=" + this.form.model.VendorId;
        } else {
        ...
        await this.$store.dispatch(
          "features/finance/payable_apply/progress/actGetAdvancePayment",
          url
        );
      },
      ...
      async handleGetSelectCN(url) {
        ...
        await this.$store.dispatch(
          "features/finance/payable_apply/progress/actGetCreditNote",
          url
        );
      },
      async handleGetSelectUnapply(url) {
        ...
        await this.$store.dispatch(
          "features/finance/payable_apply/progress/actGetUnapply",
          url
        );
      },
      async onOpenSelectApplyOption() {
        if (this.form.model.DocumentType == 'ADVANCE') {
          this.handleGetSelectADV();

          this.isShowSelectCN = false;
          this.isShowSelectUnapply = false;
          this.isShowSelectADV = true;
        }else if (this.form.model.DocumentType == 'PAYMENT') {
          this.handleGetSelectUnapply();
          
          this.isShowSelectADV = false;
          this.isShowSelectCN = false;
          this.isShowSelectUnapply = true;
        } else {
          this.handleGetSelectCN();
      ...
      async onAddPayableInvoice() {
        this.handleGetSelectPayable();
        this.isShowSelectInvoice = true;
      },
      async handleGetSelectPayable(url) {
        if (url == undefined) {
        ...
        await this.$store.dispatch(
          "features/finance/payable/payable_history/actGetPendingPayable",
          url
        );
      },
      async handleSelectPayable(row) {
        ...
        if (Array.isArray(this.form.dataDetails)) {
          for (let i = 0; i < this.form.dataDetails.length; i++) {
            if (
              this.form.dataDetails[i].PayableTransactionId ===
              row.PayableTransactionId
            ) {
              exist = true;
              break;
            }
      ...
      resetForm() {
        (this.form.model.PayableApplyId = "00000000-0000-0000-0000-000000000000"),
        ...
        this.form.model.PaymentHeaderId =
          "00000000-0000-0000-0000-000000000000";
        this.form.model.VendorId = "00000000-0000-0000-0000-000000000000";
        this.form.model.DocumentNo = "";
        this.form.model.DocumentType = "PAYMENT";
        ...
        this.form.model.APApplyDetails = [];
        this.form.dataDetails = [];
        ...
        this.form.display.ReffDocumentNo = "";
        this.form.display.VendorCode = "";
        this.form.display.VendorName = "";
        this.form.display.AvailableBalance = 0;
      ...
      async onSelectedVendor(item, modelReff) {
        ...
        this.form.display.VendorName = item.VendorName;
        this.form.display.VendorCode = item.VendorCode;
      },
      async handleEdit(row) {
        this.isForm = true;

        //BINDING EDITTED DATA
        this.form.model.PayableApplyId = row.PayableApplyId;
        ...
        this.form.display.IsMultiply = row.IsMultiply;
        this.form.display.AvailableBalance = row.OriginatingTotalPaid;

        this.form.display.VendorCode = row.VendorCode;
        this.form.display.VendorName = row.VendorName;
        ...
        //BEGIN DETAILS
        var details = row.APApplyDetails;
        let arrDetails = [];
        if (details.length) {
        ...
        //ACTIVATE BUTTONS
        if (
          this.form.model.PayableApplyId != "" &&
          this.form.model.DocumentNo != ""
        ) {
      ...
      async doDelete(row) {
        ...
        await this.$store.dispatch(
          "features/finance/payable_apply/progress/actDelete",
          row
        );

        var response = this.$store.state.features.finance.payable_apply.progress
          .resultDelete;
      ...
      async onSubmit() {
        if (this.validateForm()) {
          ...
          this.form.model.APApplyDetails = this.form.dataDetails;

          if (this.form.isEdit) {
            await this.$store.dispatch(
              "features/finance/payable_apply/progress/actUpdate",
              this.form.model
            );
            var response = this.$store.state.features.finance.payable_apply
            ...
            await this.$store.dispatch(
              "features/finance/payable_apply/progress/actCreate",
              this.form.model
            );
            var response = this.$store.state.features.finance.payable_apply
      ...
      async doPostingJournal(row) {
        ...
        await this.$store.dispatch(
          "features/finance/payable_apply/progress/actPosting",
          this.form.model
        );
      ...
      async doVoidJournal(row) {
        ...
        await this.$store.dispatch(
          "features/finance/payable_apply/progress/actVoid",
          this.form.model
        );
