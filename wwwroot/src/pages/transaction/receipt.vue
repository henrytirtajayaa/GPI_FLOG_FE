<template>
  <div class="animated fadeIn">
                ...
                <div slot="header">
                  ...
                  <div right style="float:right;">
                    <b-button
                      ...
                      @click="handlePrintOut"
                      v-b-tooltip.hover
                      title="View Print Out"
                    >
                    ...
                    <b-button
                      variant="green"
                      @click="clickPosting"
                      v-if="form.isEdit&&form.model.Status==1"
                      v-b-tooltip.hover
                    ...
                    <b-button
                      ...
                      v-if="form.isEdit&&form.model.Status==8 &&(isCreated==true)"
                    >
                      <font-awesome-icon
                        :icon="['fas', 'ban']"
                        v-b-tooltip.hover
                    ...
                    <b-button
                      variant="blue"
                      type="submit"
                      v-if="form.model.Status==0||form.model.Status==1 &&(isCreated == true)||!form.isEdit"
                    >
                ...
                <b-row>
                  ...
                  <b-col sm="12">
                    <b-alert
                      show
                      variant="danger"
                      v-if="form.model.OriginatingTotalPaid < form.model.AppliedTotalPaid"
                    >
                      <h6 style="text-align:center; padding-top:5px;">
                        <font-awesome-icon :icon="['fas', 'exclamation-circle']" />&nbsp;
                        <b>ORG. PAID AMOUNT MUST LARGER THAN APPLIED TOTAL PAID AMOUNT !</b>
                      </h6>
                    </b-alert>
                  </b-col>
                  <b-col sm="10">
                      ...
                      <b-col sm="3">
                        ...
                        <b-input-group>
                          ...
                          <b-input-group-append
                            v-if="actionButton.AllowEdit && !form.StatusApproval && !form.Void"
                          >
                            <b-form-datepicker
                    ...
                    <b-row class="mt-2">
                      ...
                      <b-col sm="5" lg="4">
                        <label for="OrgTotalPaid" class="text-primary">
                          <b>Originating Receipt Amount</b>
                        </label> &nbsp;
                        <font-awesome-icon
                          v-if="form.model.OriginatingTotalPaid < form.model.AppliedTotalPaid"
                          style="color:red"
                        ...
                        <!-- VALIDATION PROVIDER -->
                        <validation-provider
                          name="Originating Receipt Amount"
                          :rules="{ min_value:1 }"
                          v-slot="validationContext"
                        >
                          <b-form-input
                            ...
                            hidden
                            :state="validateState(validationContext)"
                            aria-describedby="OrgTotalPaid-amount-feedback"
                          ></b-form-input>
                ...
                <b-row class="mb-2">
                  <b-col>
                    <b-button
                      ...
                      :disabled="form.model.CustomerId == '' || form.model.CheckbookCode == '' || form.model.OriginatingTotalPaid == 0"
                    >
                    ...
                    >
                      <thead>
                        <tr>
                          ...
                          <th class="text-left text-uppercase">Customer Doc. No</th>
                          ...
                          <th class="text-left text-uppercase">Applied Receipt AMOUNT</th>
                        </tr>
                      </thead>
                          ...
                          <tr>
                            <td class="text-center">
                              <a
                                ...
                                @click="DeleteReceivable(itemIndex)"
                                v-if="actionButton.AllowEdit"
                                :disabled="!actionButton.AllowEdit "
                              >
                                <font-awesome-icon
                            ...
                            <td width="10%">{{item.CustomerDocNo}}</td>
                            ...
                            <td width="12%">
                              <b-input-group prepend>
                                <money
                                  v-model="item.existingRemainingDocAmount"
                                  v-bind="moneyOptions"
                                  class="currency-money-field"
                                  v-show="false"
                                ></money>
                                <money
                                  v-model="item.RemainingDocAmount"
                                  v-bind="moneyOptions"
                                  class="currency-money-field"
                                  disabled
                                  style="width:100%"
                      ...
                      <tfoot>
                        <template>
                          <tr>
                            <th colspan="7">
                              ...
                              >
                                <b-form-input
                                  ...
                                  hidden
                                  :state="validateState(validationContext)"
                                  aria-describedby="ApplTotalPaid-amount-feedback"
                                ></b-form-input>
                            ...
                            <th
                              colspan="2"
                              style="font-size:12px; text-align:right; padding:0 5px 0 0;"
                            >
                              <font-awesome-icon
                                v-if="form.model.OriginatingTotalPaid < form.model.AppliedTotalPaid"
                                style="color:red"
                                :icon="['fas', 'exclamation-circle']"
                              ></font-awesome-icon>APPLIED TOTAL RECEIPT AMOUNT
                            </th>
                            <th style="padding-right:5%;">
                              <money
                                v-model="form.model.OriginatingTotalReceivable"
                                v-bind="moneyOptions"
                                class="currency-money-field"
                                :value="SubOriginatingTotalReceivable"
                                v-show="false"
                              ></money>
                              <money
                                v-model="form.model.AppliedTotalPaid"
        ...
        <b-row>
          <b-col cols="12" sm="12">
            <b-card width="100%">
              <DataGrid
                ref="gridProsess"
                :fields="this.$store.state.features.finance.receipt.receipt_transaction.headers"
                :items="this.$store.state.features.finance.receipt.receipt_transaction.data"
                :info="this.$store.state.features.finance.receipt.receipt_transaction.listInfo"
                :baseUrl="this.$store.state.features.finance.receipt.receipt_transaction.baseUrl"
                ...
                pagination
                column-filter
                caption="Customer Receipt - Progress"
              ></DataGrid>
            </b-card>
          </b-col>
        </b-row>
          ...
          <b-row>
            <b-col cols="12" sm="12">
              <b-card width="100%">
                <DataGrid
                  ref="gridHistory"
                  :fields="this.$store.state.features.finance.receipt.receipt_history.headers"
                  :items="this.$store.state.features.finance.receipt.receipt_history.data"
                  :info="this.$store.state.features.finance.receipt.receipt_history.listInfo"
                  :baseUrl="this.$store.state.features.finance.receipt.receipt_history.baseUrl"
    ...
    <b-modal v-model="isShowReceivable" hide-footer size="lg">
      <template v-slot:modal-title>Select Receivable</template>
      <div class="d-block text-center">
        <SelectGrid
          ref="gridReceivable"
          :fields="[  {label: 'Master No', key: 'MasterNo', width:110},
                      ...
                      {label: 'NS Doc. No', key: 'NSDocumentNo', width:110},
    ...
    <b-modal
      id="modal-approveposting-reason"
    ...
    >
      <form ref="formdisapprove" @submit.stop.prevent="handleDisApprove">
        <b-form-group
          ...
          invalid-feedback="Reason must not empty"
        >
          <b-form-input id="name-input" v-model="form.VoidReason" :state="disapproveState" required></b-form-input>
        </b-form-group>
      </form>
...
export default {
  ...
  methods: {
      ...
      let routeData = this.$router.resolve(
        {
          ...
          query: {
            ...
            'DocId' : this.form.model.ReceiptHeaderId, 
    ...
    async limitValue(index) {
      if (
        this.dataDetails[index]["OrgPaidAmount"] >
        this.dataDetails[index]["RemainingDocAmount"]
      ) {
        this.dataDetails[index]["OrgPaidAmount"] = this.dataDetails[index][
          "RemainingDocAmount"
        ];
      }
    },
    ...
    async handleGet(url) {
      await this.$store.dispatch(
        "features/finance/receipt/receipt_history/actGetData",
        url
      );
    ...
    async handleGetProgress(url) {
      await this.$store.dispatch(
        "features/finance/receipt/receipt_transaction/actGetData",
        url
      );
      await loginServices.doLoginCompany(
        this.$store.state.user,
    ...
    async History() {
      this.itemHistory = this.$store.state.features.finance.receipt.receipt_history.data;
      this.HistoryInfo = this.$store.state.features.finance.receipt.receipt_history.listInfo;
    },
    ...
    CekDetail(DocumentNo) {
      ...
      for (var i = 0; i < this.dataDetails.length; i++) {
        if (this.dataDetails[i].DocumentNo == DocumentNo) isdoc = false;
      }
      return isdoc;
    },
    async CekValueRemainingDocAmount(
      ReceiveTransactionId,
      OriginatingExtendedAmount
    ) {
      var value = 0;
      await this.$store.dispatch(
        "features/finance/receipt/receipt_transaction/actGetDataDetail",
        "GetReceiptDetail?" + "&ReceiveTransactionId=" + ReceiveTransactionId
      );
      var Dataexisting = await this.$store.state.features.finance.receipt
        .receipt_transaction.dataDetail;
    ...
    resetForm() {
      this.form.model.ReceiptHeaderId = "";
    ...
    async initDefaultForm() {
      var ReceivableSetup = this.$store.state.features.company.receivable_setup
        .data;
    ...
    async handleEdit(row) {
      ...
      row.ArReceiptDetails.forEach(function(d, index) {
        arrDetail.push({
      ...
      if (row.CreatedBy == this.$store.state.user) this.isCreated = true;
    ...
    async doDelete(row) {
      ...
      await this.$store.dispatch(
        "features/finance/receipt/receipt_transaction/actPutTrxDelete",
        row
      );

      var response = this.$store.state.features.finance.receipt
        .receipt_transaction.resultTrxDelete;
    ...
    validateForm() {
      ...
      if (!valid)
        this.handleToast(
          "Warning",
          "danger",
          "Paid Amount in Detail data  must not less than 0 (zero) !"
        );
      ...
      if (this.validateForm()) {
        ...
        this.dataDetails.forEach(function(row, index) {
          arrDetail.push({
            ...
            ReceiptHeaderId: "00000000-0000-0000-0000-000000000000",
            ...
            FunctionalBalance: multiply
              ? (row.OrgDocAmount - row.OrgPaidAmount) * rate
              : (row.OrgDocAmount - row.OrgPaidAmount) / rate,
            OriginatingPaid: row.OrgPaidAmount,
            FunctionalPaid: multiply
              ? row.OrgPaidAmount * rate
              : row.OrgPaidAmount / rate,
            Status: 0
          });
        });

        this.form.model.ArReceiptDetails = arrDetail;

        if (this.form.isEdit) {
          await this.$store.dispatch(
            "features/finance/receipt/receipt_transaction/actUpdate",
            this.form.model
          );
          var response = this.$store.state.features.finance.receipt
            .receipt_transaction.resultUpdate;
          if (response.status != 200) {
            this.handleToast(
              "Confirmation",
              "danger",
          ...
          await this.$store.dispatch(
            "features/finance/receipt/receipt_transaction/actCreate",
            this.form.model
          );

          var response = this.$store.state.features.finance.receipt
            .receipt_transaction.resultCreate;
    ...
    async onSelectedCustomer(item, modelReff) {
      ...
      this.form.model.ArReceiptDetails = [];
      this.dataDetails = [];
    },
    ...
    async doVoidJournal(row) {
      ...
      await this.$store.dispatch(
        "features/finance/receipt/receipt_transaction/actVoid",
        this.form.model
      );
      var response = this.$store.state.features.finance.receipt
        .receipt_transaction.resultPosting;
    ...
    async doSubmitReceipt(row) {
      ...
      await this.$store.dispatch(
        "features/finance/receipt/receipt_transaction/actSubmitApproval",
        this.form.model
      );
    ...
    async doDisApprove(row) {
      ...
      await this.$store.dispatch(
        "features/finance/receipt/receipt_transaction/actDisApprove",
        this.form.model
      );
    ...
    async doRevise(row) {
      ...
      await this.$store.dispatch(
        "features/finance/receipt/receipt_transaction/actRevise",
        this.form.model
      );
    ...
    async doApprove(row) {
      ...
      await this.$store.dispatch(
        "features/finance/receipt/receipt_transaction/actApprove",
        this.form.model
      );
    ...
    async doPostingReceipt(row) {
      ...
      this.form.model.PersonId = this.$store.state.user;
      await this.$store.dispatch(
        "features/finance/receipt/receipt_transaction/actPosting",
        this.form.model
      );
    ...
    async handleGetReceivableSelect(url) {
      if (url == undefined) {
        url =
          "GetPendingReceivable?CustomerId=" +
          this.form.model.CustomerId +
          "&CurrencyCode=" +
          this.form.model.CurrencyCode;
      } else {
    ...
    async handleSelectReceivable(row) {
      ...
      if (Array.isArray(this.dataDetails)) {
        for (let i = 0; i < this.dataDetails.length; i++) {
          if (
            this.dataDetails[i].ReceiveTransactionId ===
    ...
    CountRemaining(index) {
      if (index != undefined) {
        if (
          this.dataDetails.length > 0 &&
          this.dataDetails[index]["OrgPaidAmount"] > 0
        )
          this.dataDetails[index]["RemainingDocAmount"] =
            this.dataDetails[index]["existingRemainingDocAmount"] -
            this.dataDetails[index]["OrgPaidAmount"];
      }
    },
    SwitchButton(Name) {
    ...
    async doApprovePosting(row) {
      ...
      await this.$store.dispatch(
        "features/finance/receipt/receipt_transaction/actApprovePost",
        this.form.model
      );
