      ...
      <b-form @submit.stop.prevent="handleSubmit(onSubmit)">
        <b-row>
          <b-col sm="12">
            <b-card>
              <div slot="header">
                <span class="font-weight-bold">Receivable Setup</span>
                <small>Config</small>
...
export default {
  ...
  methods: {
    ...
    async onBind() {
      var data = this.$store.state.features.company.receivable_setup.data;
      data = data[0];
      if (data != undefined) {
        this.form.model.ReceivableSetupId = data.ReceivableSetupId;
    ...
    async handleSubmit() {
      ...
      if (this.form.model.ReceivableSetupId != null) {
        await this.$store.dispatch(
          "features/company/receivable_setup/actUpdate",
          this.form.model
        );
        var response = this.$store.state.features.company.receivable_setup
          .resultUpdate;
        ...
        await this.$store.dispatch(
          "features/company/receivable_setup/actCreate",
          this.form.model
        );
